...
RAW_IMAGES=$(aws ecr describe-images --repository-name node-react-repo --output json)
...
IMAGE_URI="577638372446.dkr.ecr.us-east-2.amazonaws.com/node-react-repo:$IMAGE_TAG"
# CONTAINER_NAME="my-app-container-react_$IMAGE_TAG" 
CONTAINER_NAME="my-app-container-react" 
...
# Run the container
docker run -d --name $CONTAINER_NAME -p 3000:3000 $IMAGE_URI
